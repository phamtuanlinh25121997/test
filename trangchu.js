...
let listArrConvert = JSON.parse(newCatMenu)
...
function rendernewCatMenu(){
  rowList.innerHTML ="";
  for(let i=0;i<listArrConvert.length;i++){
    rowList.innerHTML = rowList.innerHTML + `
    <div class="col" id="${listArrConvert[i].id}">
      <div class="card row2" style="width: 336px;">
        <img src="${listArrConvert[i].img}" class="card-img-top" alt="...">
        <div class="card-body">
          <p class="card-title">${listArrConvert[i].name}</p>
          <div class="div-like">
            <a href="./chitiet.html?catID=${listArrConvert[i].id}" class="btn btn-primary">Chi tiết</a>
            <button class="button-heart"><i class="ti-heart"></i></button>
              <a href="./giohang.html" class="btn btn-primary">Mua ngay</a>
          </div>
        </div>
      </div>
    </div>`
...
//         <p class="card-title">${listArrConvert[i].name}</p>
//         <div class="div-like">
//           <a href="./chitiet.html" class="btn btn-primary">Chi tiết</a>
//           <button class="button-heart"><i class="ti-heart"></i></button>
//             <a href="./giohang.html" class="btn btn-primary">Mua ngay</a>
//         </div>
//       </div>
